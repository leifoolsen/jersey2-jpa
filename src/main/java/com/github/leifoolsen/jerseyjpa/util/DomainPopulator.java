    ...
    public static List<Book> getBooks(final Map<String, Publisher> publishers) {
        ...
        return Arrays.asList(
                Book.with("9781846883668")
                        ...
                        .published(LocalDate.of(2014, Month.NOVEMBER, 18))
                ...
                Book.with("9788253019727")
                        ...
                        .published(LocalDate.of(1998, Month.JANUARY, 1))
                ...
                Book.with("9781784700089")
                        ...
                        .published(LocalDate.of(2014, Month.NOVEMBER, 13))
                ...
                Book.with("9780099554486")
                        ...
                        .published(LocalDate.of(2015, Month.JANUARY, 8))
                ...
                Book.with("9788202244699")
                        ...
                        .published(LocalDate.of(2012, Month.SEPTEMBER, 1))
                ...
                Book.with("9788202425975")
                        ...
                        .author("Loe, Erlend")
                        .publisher(publishers.get(CAPPELEN_DAMM))
                        .published(LocalDate.of(2013, Month.OCTOBER, 1))
                ...
                Book.with("9780241971987")
                        ...
                        .published(LocalDate.of(2014, Month.SEPTEMBER, 29))
